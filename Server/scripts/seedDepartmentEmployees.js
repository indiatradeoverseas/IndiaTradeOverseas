...
const testAccounts = [
  ...
  },
  {
    ...
    name: 'Pooja Verma',
    email: 'hr@indiatradeoverseas.com',
    password: UNIFIED_PASSWORD,
    role: 'HR_MANAGER',
    department: 'HR',
  ...
  {
    employeeId: 'EMP-HRM-002',
    fullName: 'Pooja Verma',
    name: 'Pooja Verma',
    email: 'hrmanager@indiatradeoverseas.com',
    password: UNIFIED_PASSWORD,
    role: 'HR_MANAGER',
    department: 'HR',
    position: 'HR Manager',
  ...
  {
    employeeId: 'EMP-HRE-002',
    fullName: 'Ananya Roy',
    name: 'Ananya Roy',
    email: 'hrexecutive@indiatradeoverseas.com',
    password: UNIFIED_PASSWORD,
    role: 'HR_EXECUTIVE',
    department: 'HR',
  ...
  },
  {
    ...
    name: 'Rajesh Verma',
    email: 'transportmanager@indiatradeoverseas.com',
    password: UNIFIED_PASSWORD,
    role: 'MANAGER',
    department: 'TRANSPORT',
  ...
  {
    employeeId: 'EMP-TRN-004',
    fullName: 'Sunil Kumar',
    name: 'Sunil Kumar',
    email: 'transportexecutive@indiatradeoverseas.com',
    password: UNIFIED_PASSWORD,
    role: 'EMPLOYEE',
    department: 'TRANSPORT',
    position: 'Transport Executive',
    phone: '+91 9811223356',
    permissions: { productUpload: false, lead: true, export: false, document: true, task: true, dispatch: true, payment: false, quotation: false, job: false }
  },
  {
  ...
  },
  {
    ...
    name: 'Amit Sharma',
    email: 'salesmanager@indiatradeoverseas.com',
    password: UNIFIED_PASSWORD,
    role: 'SALES_MANAGER',
    department: 'SALES',
  ...
  {
    employeeId: 'EMP-SAL-004',
    fullName: 'Sumit Joshi',
    name: 'Sumit Joshi',
    email: 'salesexecutive@indiatradeoverseas.com',
    password: UNIFIED_PASSWORD,
    role: 'SALES_EXECUTIVE',
    department: 'SALES',
