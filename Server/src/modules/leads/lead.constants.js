...
/**
 * These values come directly from the Master DPR.
 *
 * Stable uppercase codes are stored in MongoDB.
 * UI can show human-friendly labels.
 */
...
/**
 * Existing operational stages currently used by the application.
 *
 * Keep these because quotations, logistics, follow-ups and existing
 * CRM screens already depend on them.
 */
const WON_STAGES =
  Object.freeze([
    'CLOSED_WON',
    ...
    // Future canonical-stage compatibility.
    'WON',
  ]);
...
/**
 * Existing operational workflow is more detailed than the Master DPR
 ...
 * QUOTATION_REQUESTED
 *
 * are useful operational stages but management reporting should still
 * represent the opportunity using the DPR lifecycle.
 */
