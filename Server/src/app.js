...
const metaLeadAdsRoutes =
  require('./modules/leads/metaLeadAds.routes');
...
const acquisitionReportRoutes =
  require('./modules/reports/acquisitionReport.routes');
...
const analyticsEventRoutes =
  require('./modules/analytics/analyticsEvent.routes');
...
const {
  sanitizeRequest
} = require('./middlewares/requestSanitization.middleware');
...
const apiRoutes = [
  ...
  {
    path: '/reports',
    router: acquisitionReportRoutes
  },
