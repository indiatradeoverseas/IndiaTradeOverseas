  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        /*
         * IMPORTANT:
         * This allows CRM to identify that this lead
         * originated from the public Contact Form.
         */
        source: 'CONTACT_FORM',
      ...
      pushDataLayerEvent('generate_lead', {
        ...
        source: 'CONTACT_FORM',
        enquiry_type: leadType
      });

      toast.success(
        response?.data?.message ||
          'Your commercial enquiry has been successfully submitted.'
      );
      ...
      if (
        ...
        toast.error(
          'Our trade intake system is temporarily unavailable. Please try again shortly.'
        );
      } else if (!error?.response) {
        toast.error(
          'Unable to connect to the trade intake system. Please check your connection and try again.'
        );
      } else {
        toast.error(
