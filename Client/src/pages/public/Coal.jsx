...
function Coal() {
  ...
  const handlePersonalDetailsSubmit = async (event) => {
    ...
    try {
      ...
      const coalVisitorSnapshot = {
        ...(response?.visitor || response?.data?.visitor || {}),
        visitorId,
        fullName: personalDetails.fullName.trim(),
        email: personalDetails.email.trim(),
        mobile: personalDetails.mobile.trim(),
        ...
        pricing:
          ...
          response?.pricing ||
          response?.visitor?.pricing ||
          response?.data?.visitor?.pricing ||
          null,
      };
      ...
      sessionStorage.setItem(
        ...
        JSON.stringify(coalVisitorSnapshot)
      );
