                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <div className="space-y-1.5 font-mono text-xs bg-white p-3 rounded-lg border border-slate-200">
                                                    ...
                                                    <div className="flex items-start justify-between gap-3 text-[#004B3B] font-extrabold text-sm sm:text-base border-t border-slate-200 pt-1.5 mt-1.5">
                                        ...
                                        <OrderButton
                                            action={async () => {
                                                if (!orderQuantity || Number(orderQuantity) < 200) {
                                                    toast.error('Minimum quantity is 200 Kg.');
                                                ...
                                                try {
                                                    ...
                                                    console.warn('Proposal log note:', err);
                                                }

                                                // Function to generate and download Tax Invoice PDF
                                                const triggerSuccessPDF = (paymentRef = '', mode = paymentMode) => {
                                                    generateInvoicePDF({
                                                        ...
                                                        productName: `Prakriti Tea (${activeDrawerLot.region})`,
                                                        grade: activeDrawerLot.grade,
                                                        quantity: Number(orderQuantity),
                                                        quantityUnit: 'Kg',
