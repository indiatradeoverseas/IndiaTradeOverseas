          ...
          handler:
            async function (
              ...
              try {
                ...
                toast.success(
                  "Coal payment verified successfully."
                );
              } catch (error) {
                console.error(
      ...
      <div style={pageStyle}>
        <div style={cardStyle}>
          ...
          <div style={priceBoxStyle}>
            ...
            <small>
              Based on the estimated valuation
              supplied in the Coal requirement.
              Final commercial quotation remains
              subject to ITO confirmation.
            </small>
          </div>
