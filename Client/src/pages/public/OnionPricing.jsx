...
export default function OnionPricing() {
  ...
  const pay = async () => {
    ...
    try {
      ...
      /*
       * Make sure the quotation contains
       * a valid payable amount.
       */
      const grandTotal =
        Number(
          visitor?.pricing
          ...
          handler:
            async (
              ...
              try {
                 ...
                 * IMPORTANT:
                 *
                 * Send exactly what Razorpay returned
                 * to the backend.
                 */
                const verify =
                ...
                /*
                 * Backend returns the created
                 * order/payment information in data.
                 */
                setSuccess(
                  verify?.data
                );
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_380px]">
          ...
          <section className="rounded-3xl bg-[#350914] p-6 sm:p-8 text-white shadow-xl">
            ...
            <button
              ...
              onClick={pay}
              className="mt-7 w-full rounded-2xl bg-[#F7F3EA] py-4 text-sm font-black uppercase tracking-wider text-[#7A2332] transition hover:bg-[#B5965A] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
            >
              {paying
                ? "Opening Razorpay…"
                : "Place Order and Pay"}
